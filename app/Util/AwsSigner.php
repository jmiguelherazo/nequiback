...
class AwsSigner
{
     ...
     */
    public static function makeSignedRequest($host, $servicePath, $method, $body, $region = 'us-east-1')
    {

        $apikey     = env('NEQUI_ACCESS');
        $secretKey  = env('NEQUI_SECRET');
        $access_key = env('NEQUI_APIKEY');
